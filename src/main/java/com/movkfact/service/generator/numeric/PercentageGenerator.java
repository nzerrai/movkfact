...
/**
 * Générateur de pourcentages aléatoires avec contraintes min/max optionnelles.
 * Plage par défaut : [0.0, 100.0]. 2 décimales.
 */
public class PercentageGenerator extends DataTypeGenerator {
    private static final Random random = new Random();

    public PercentageGenerator(ColumnConfigDTO columnConfig) {
        super(columnConfig);
    }
